...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ طباعة افاتورة</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tr>
                                    ...
                                    @php($total = $invoices->Amount_collection + $invoices->Amount_Commission)
                                    <td class="tx-right">الاجمالي</td>
                                    <td class="tx-right" colspan="2">{{number_format($total,2)}}</td>
                                </tr>
                                <tr>
                                    <td class="tx-right">الضريبة {{$invoices->Rate_VAT}}</td>
