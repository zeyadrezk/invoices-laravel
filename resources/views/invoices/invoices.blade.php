                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                @can('تغير حالة الدفع')
                                                    <a class="dropdown-item"
                                                       href="{{route('invoices.status.show',[$invoice->id])}}">
                                                        <i class="text-success fa fa-credit-card"></i>&nbsp;&nbsp;تغيير
                                                        حالة
                                                        الدفع </a>
                                                @endcan
                                                ...
                                                @can('ارشفة الفاتورة')
                                                    <a class="dropdown-item" href="#"
                                                       ...
                                                       data-toggle="modal" data-target="#archive_invoice">
                                                        <i class="text-orange fas fa-archive"></i>&nbsp;&nbsp;ارشفة
                                                        الفاتورة</a>
                                                @endcan
                                                ...
                                                @can('طباعةالفاتورة')
                                                    <a class="dropdown-item"
                                                       href="{{url('invoices/print')}}/{{$invoice->id}}">
